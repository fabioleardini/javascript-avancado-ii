            ...
            NegociacaoController = function () {
                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function adiciona(event) {
                        ...
                        var negocicao = this._criaNegociacao();

                        this._service.cadastra(negocicao).then(function (mensagem) {
                            _this2._listaNegociacoes.adiciona(negocicao);
                    ...
                    value: function apaga() {
                        ...
                        this._service.apaga().then(function (mensagem) {
                            _this4._mensagem.text = mensagem;
